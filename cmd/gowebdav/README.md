...
* `NC_UPLOADS_URL` absolute Nextcloud uploads URL (e.g. `https://server/remote.php/dav/uploads/<user>/`) for PUTCHUNK; optional if destination includes `/files/<user>/` and can be auto-derived.
